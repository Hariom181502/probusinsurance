...
@Component({
  selector: 'app-proposal-terms-conditions',
  imports: [CommonModule,MaterialModule,InnerHeaderComponent],
  templateUrl: './proposal-terms-conditions.component.html',
  styleUrl: './proposal-terms-conditions.component.scss'
})
export class ProposalTermsConditionsComponent {
